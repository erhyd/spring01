...
public class CountrySearchControllerTests {
	...
	public void test00_testRestTemplate(){
		System.out.println("TestRestTemplate= " + rest);
	}
	...
	public void test02_getPage(){
		String html = rest.getForObject("/country/page/1", String.class);
		System.out.println(html);
	}
	
	@Test
	public void test02_getPage_NotFoundRuntimeException(){
		String html = rest.getForObject("/country/page/xxx", String.class);
		System.out.println(html);
	}
